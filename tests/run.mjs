...
assert.match(featureStyles,/\.dungeon-grid.*\.dungeon-summary.*\.dungeon-entrance-grid/s,"Dungeon collection and detail layouts must retain responsive style contracts");
