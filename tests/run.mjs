...
assert.match(main,/focusId=event\.currentTarget===elementDefender\?"element-defender":"element-attacker"/,"Element comparison focus restoration must follow the control that changed");
