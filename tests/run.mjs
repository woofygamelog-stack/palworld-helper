...
assert.match(main,/id="element-defender-primary".*id="element-defender-secondary".*id="element-dual-pal".*element-component.*element-formula/s,"Element comparison must expose two defending elements, a dual-Pal shortcut, component effects, and the fail-closed formula panel");
