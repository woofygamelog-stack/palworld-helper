...
const [palData,itemData,itemRelationData,guideSnapshotData,skillData,npcData,dungeonData,technologyData,healthData,elementData,structureData,expeditionData,questData,template]=await Promise.all(["pals","items","item-relations","guide-snapshots","skills","npcs","dungeons","technology","health","elements","structures","expeditions","quests"].map(name=>readFile(`public/data/${name}.json`,"utf8").then(JSON.parse)).concat(readFile("dist/index.html","utf8")));
if(itemRelationData.meta.schema!==1||itemRelationData.meta.gameBuild!=="24467282"||itemRelationData.meta.verification!=="verified"||itemRelationData.meta.linkedItemCount!==1729||itemRelationData.meta.recipeCount!==1286||itemRelationData.meta.recipeOutputRelationCount!==1286||itemRelationData.meta.recipeIngredientRelationCount!==3676||itemRelationData.meta.technologyUnlockRelationCount!==382||itemRelationData.meta.structureMaterialRelationCount!==992||itemRelationData.meta.structureProductionRelationCount!==12||itemRelationData.meta.npcSoldItemRelationCount!==187||itemRelationData.meta.npcRequestedItemRelationCount!==10||itemRelationData.meta.npcRewardedItemRelationCount!==94||itemRelationData.meta.dungeonItemRelationCount!==1072||itemRelationData.meta.expeditionRewardRelationCount!==209||itemRelationData.meta.questRewardRelationCount!==63)throw new Error("Item relationship dataset baseline mismatch");
if(technologyData.meta.schema!==1||technologyData.meta.gameBuild!=="24467282"||technologyData.meta.verification!=="verified"||technologyData.meta.technologyCount!==588||technologyData.technologies.length!==588)throw new Error("Technology dataset baseline mismatch");
if(structureData.meta.schema!==1||structureData.meta.gameBuild!=="24467282"||structureData.meta.verification!=="verified"||structureData.meta.structureCount!==472||structureData.structures.length!==472)throw new Error("Structure dataset baseline mismatch");
if(expeditionData.meta.schema!==1||expeditionData.meta.gameBuild!=="24467282"||expeditionData.meta.verification!=="verified"||expeditionData.meta.expeditionCount!==18||expeditionData.expeditions.length!==18||expeditionData.meta.rewardSlotCount!==169||expeditionData.meta.rewardRowCount!==279||expeditionData.meta.probabilitiesVerified!==false||expeditionData.meta.durationFormulaVerified!==false)throw new Error("Expedition dataset baseline mismatch");
if(healthData.meta.schema!==2||healthData.meta.gameBuild!=="24467282"||healthData.meta.verification!=="verified"||healthData.meta.behaviorCount!==7||healthData.meta.conditionCount!==7||healthData.meta.medicineCount!==3||healthData.meta.sourceValuesVerified!==true||healthData.meta.runtimeApplicationVerified!==false)throw new Error("Health dataset baseline mismatch");
if(elementData.meta.schema!==3||elementData.meta.gameBuild!=="24467282"||elementData.meta.verification!=="verified-and-runtime"||elementData.meta.elementCount!==9||elementData.meta.relationCount!==9||elementData.meta.numericMultipliersVerified!==true||elementData.meta.dualElementRuleVerified!==true||elementData.rules.numericMultipliers?.strong!==1.5||elementData.rules.numericMultipliers?.weak!==.66||elementData.rules.dualElement?.multipliersByWeakCount?.["-2"]!==.43||elementData.rules.dualElement?.multipliersByWeakCount?.["2"]!==2.25||elementData.rules.dualElement?.sameElementResistance!=="all-except-neutral"||elementData.rules.dualElement?.neutralAttackIsNeverWeak!==true||"chartImage" in elementData)throw new Error("Element dataset baseline mismatch");
if(questData.meta.schema!==1||questData.meta.gameBuild!=="24467282"||questData.meta.verification!=="verified"||questData.meta.localeCount!==17||questData.meta.questCount!==82||questData.meta.mainCount!==32||questData.meta.sideCount!==50||questData.meta.objectiveStepCount!==74||questData.meta.rewardItemRelationCount!==63||questData.quests.length!==82)throw new Error("Quest dataset baseline mismatch");
if(guideSnapshotData.meta.schema!==1||guideSnapshotData.meta.gameBuild!=="24467282"||guideSnapshotData.meta.verification!=="verified"||guideSnapshotData.meta.localeCount!==17||guideSnapshotData.meta.guideCount!==6||guideSnapshotData.meta.metricCount!==25)throw new Error("Guide snapshot dataset baseline mismatch");
const data={palData,itemData,itemRelationData,guideSnapshotData,skillData,npcData,dungeonData,technologyData,healthData,elementData,structureData,expeditionData,questData};
