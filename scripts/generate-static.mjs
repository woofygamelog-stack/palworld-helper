...
const skillsTitles={"en-US":"Skills","zh-CN":"技能","zh-TW":"技能","ja-JP":"スキル","fr-FR":"Compétences","it-IT":"Abilità","de-DE":"Fähigkeiten","es-ES":"Habilidades","pt-BR":"Habilidades","ru-RU":"Навыки","ko-KR":"스킬","id-ID":"Skill","es-419":"Habilidades","th-TH":"สกิล","tr-TR":"Beceriler","vi-VN":"Kỹ năng","pl-PL":"Umiejętności"};
...
const routeMeta=(route,m,locale)=>{
  ...
  if(route==="skills")return {title:skillsTitles[locale],description:`${skillsTitles[locale]} · Palworld`};
...
for (const locale of locales) {
  for (const route of routes) {
    ...
    const m=messages(locale),meta=routeMeta(route,m,locale),fullTitle=`${meta.title} · Palworld Helper`,safeTitle=escapeHtml(fullTitle),safeDescription=escapeHtml(meta.description);
...
await writeFile("dist/index.html", `<!doctype html><html lang="en-US"><head><meta charset="utf-8"><meta name="google-site-verification" content="vcYPQJf0I03LumjZIODPdq47ZnYMCRvD2ABcBFyBImQ"><meta name="google-adsense-account" content="ca-pub-1986785092914105"><meta http-equiv="refresh" content="0; url=/en-US"><link rel="canonical" href="${origin}/en-US"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="manifest" href="/site.webmanifest"><title>Palworld Helper</title></head><body><a href="/en-US">Continue to Palworld Helper</a></body></html>`);
