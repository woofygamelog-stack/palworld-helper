...
if(healthData.meta.schema!==2||healthData.meta.gameBuild!=="24181527"||healthData.meta.verification!=="game-files"||healthData.meta.behaviorCount!==7||healthData.meta.conditionCount!==7||healthData.meta.medicineCount!==3||healthData.meta.sourceValuesVerified!==true||healthData.meta.runtimeApplicationVerified!==false)throw new Error("Health dataset baseline mismatch");
if(elementData.meta.schema!==2||elementData.meta.gameBuild!=="24181527"||elementData.meta.verification!=="game-ui-chart-and-game-files"||elementData.meta.elementCount!==9||elementData.meta.relationCount!==9||"chartImage" in elementData)throw new Error("Element dataset baseline mismatch");
