...
const [palData,itemData,itemRelationData,skillData,mapData,mapPoints,npcData,dungeonData,technologyData,structureData,expeditionData,questData,healthData,elementData,condensingData,ivData]=await Promise.all([
  "pals","items","item-relations","skills","map-markers","map-points","npcs","dungeons","technology","structures","expeditions","quests","health","elements","condensing","iv"
].map(name=>readJson(`public/data/${name}.json`)));

const seoData={palData,itemData,itemRelationData,skillData,npcData,dungeonData,technologyData,healthData,elementData,structureData,expeditionData,questData};
