...
const itemRelationEntries=Object.entries(itemRelationData.byItem),itemRelationTechnologySlugs=new Set(itemRelationData.technologies.map(entry=>entry.slug)),itemRelationStructureSlugs=new Set(itemRelationData.structures.map(entry=>entry.slug)),itemRecipeById=new Map(itemData.recipes.map(recipe=>[recipe.id,recipe]));
