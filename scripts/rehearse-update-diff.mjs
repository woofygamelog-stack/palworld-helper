...
const routeByDomain={pals:["pals","calculators/pal-compare","calculators/team-builder","calculators/iv","guides/getting-started","guides/breeding","guides/base","guides/combat"],items:["database","calculators/crafting","guides/getting-started","guides/base","guides/server"],activeSkills:["skills/active","guides/combat"],passiveSkills:["skills/passive","guides/breeding"],partnerSkills:["skills/partner"],npcs:["database/npcs","map"],dungeons:["database/dungeons","map"],technology:["database/technology","guides/getting-started","guides/returning-player"],structures:["database/structures","guides/base","guides/server"],expeditions:["database/expeditions","guides/returning-player"],quests:["database/quests","guides/returning-player"],conditions:["database/health","guides/combat"],elements:["database/elements","calculators/team-builder","guides/combat"],condensing:["calculators/condensing"]};
