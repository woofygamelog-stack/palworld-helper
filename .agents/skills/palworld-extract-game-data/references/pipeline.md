...
- Treat the installed official element matchup chart as a qualitative, hashed private validation source. Its transcribed directed relationships do not verify numeric multipliers, inverse resistance values, or dual-element rules. Do not copy the chart into public assets; render normalized relationships with project-owned HTML/CSS.
