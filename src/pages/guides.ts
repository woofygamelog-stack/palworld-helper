...
import {guideCopy,guideDefinitions,guideMetricKindLabels,guidePreparationKindLabels,guideResultKindLabels,guideStepKindLabels,guideStructureCopy,findGuide,guideRoute,type GuideSnapshotData} from "../guide-content.ts";
