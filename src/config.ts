...
export const site = { name:"Palworld Helper", origin:env.VITE_SITE_ORIGIN||"https://palworld-helper.woofy.blog", gameVersion:"1.0.0", gameBuild:"24467282", supportUrl:env.VITE_SUPPORT_URL||"",analyticsId:env.VITE_GA_ID||"G-FF7N186M72",searchConsoleVerification:env.VITE_SEARCH_CONSOLE_VERIFICATION||"vcYPQJf0I03LumjZIODPdq47ZnYMCRvD2ABcBFyBImQ",adsenseClient:env.VITE_ADSENSE_CLIENT||"ca-pub-1986785092914105",adsenseContentSlot:env.VITE_ADSENSE_CONTENT_SLOT||"" } as const;
